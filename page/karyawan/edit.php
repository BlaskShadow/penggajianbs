                ...
                <div class="card-body text-bg-dark p-3">
                    <div class="form-group row">
                        ...
                        <div class="row mb-4">
                            ...
                            <div class="col-8">
                                <input name="nik" type="text" class="form-control" placeholder="NIK" value="<?= $data['nik'] ?>">
                            </div>
                        </div>
                        <!-- INPUT END -->
                        ...
                        <div class="row mb-4">
                            ...
                            <div class="col-8">
                                <input name="gaji_pokok" type="number" class="form-control" placeholder="Gaji Pokok" value="<?= $data['gaji_pokok'] ?>">
                            </div>
                        </div>
                        <!-- INPUT END -->
