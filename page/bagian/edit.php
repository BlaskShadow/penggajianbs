                    ...
                    <div class="form-group row">
                        <div class="row mb-3 mt-3" >
                            ...
                            <div class="col-10 mb-3">
                                <input name="id" class="form-control" type="number" placeholder="ID" value="<?=$data['id'] ?>" readonly>
                            </div>

                            <label style="color: dark;" class="col-2">Nama</label>
                            <div class="col-10 mb-3">
                                <input name="nama" class="form-control" type="text" placeholder="Nama Bagian" value="<?=$data['nama'] ?>">
                            </div>
                        </div>
                    </div>
                </div>
